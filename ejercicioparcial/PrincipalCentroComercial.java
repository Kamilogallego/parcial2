        ...
        do {
            ...
            switch (opc) {
                case "1": {
                    ...
                    String ca = s.next();
                    ((CentroImple) repo).save(new CentroComercialDTO(id,nom, cat, ca ));
                    break;
                }
                case "2": {
                    List<CentroComercialDTO> productos = ((CentroImple) repo).findAll();
                ...
                case "3": {
                    ...
                    ((CentroImple) repo).update(beaActualizar);
                    break;
                }
                case "4": {
                    ...
                    Integer id = s.nextInt();
                    ((CentroImple) repo).delete(((CentroImple) repo).findById(id));
                    ((CentroImple) repo).findAll().forEach(System.out::println);
                    break;
                }
                case "5": {
                    opc = "5";
